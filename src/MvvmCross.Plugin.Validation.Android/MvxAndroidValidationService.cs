...
namespace MvvmCross.Plugin.Validation.Android
{
    public class MvxAndroidValidationService : MvxValidationService
    {
        ...
        public MvxAndroidValidationService(IValidator validator, IMvxMessenger messenger, IMvxLog log)
        ...
        protected override object GetTargetFromBinding(object targetBinding)
        {
            ...
            if (textBinding != null)
            {
                ...
                {
                    Log.Error("TextView on {0} cannot be found.", typeof(MvxTextViewTextTargetBinding));
                }
            }
            return boundView;
        }
