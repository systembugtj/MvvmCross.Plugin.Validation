...
nuget add MvvmCross.Plugin.Validation.2.2.4.nupkg -source ~/localpackages

nuget add MvvmCross.Plugin.Validation.ForFieldBinding.2.2.4.nupkg -source ~/localpackages
